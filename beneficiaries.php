      ...
      <nav class="top-bar" data-topbar>
        ...
        <section class="top-bar-section">
          ...
          <ul class="right">
            ...
            <li class="active"><a href="#">Beneficiaries</a></li>
          ...
          <div class="large-8 left columns">
              ...
              <h2>Watch the video</h2>
                <div class="flex-video">
                    <iframe width="560" height="315" src="//www.youtube.com/embed/0_T9eDw9tMU" frameborder="0" allowfullscreen></iframe>
                </div>
              <hr />
